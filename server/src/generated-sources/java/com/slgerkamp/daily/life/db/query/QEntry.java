...
public class QEntry extends com.querydsl.sql.RelationalPathBase<QEntry> {
    ...
    public final NumberPath<Long> postDate = createNumber("postDate", Long.class);
    ...
    public void addMetadata() {
        ...
        addMetadata(postDate, ColumnMetadata.named("POST_DATE").withIndex(4).ofType(Types.BIGINT).withSize(19).notNull());
